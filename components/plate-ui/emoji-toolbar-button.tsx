...
export function EmojiPopover({
  ...
  return (
    <Popover.Root open={isOpen} onOpenChange={setIsOpenAction}>
...
export function EmojiPicker({
  ...
  return (
    <div
      className={cn(
        "bg-popover text-popover-foreground flex flex-col rounded-none",
...
> = {
  ...
  foods: {
    outline: <OrangeSliceIcon className="size-full" />,
    solid: <OrangeSliceIcon className="size-full" />,
  },
  ...
  symbols: {
    outline: <MusicNotesIcon className="size-full" />,
    solid: <MusicNotesIcon className="size-full" />,
  },
};
