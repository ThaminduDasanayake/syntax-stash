      ...
      >
        {isDropdown ? (
          <>
            ...
            <div>
              <CaretDownIcon className="text-muted-foreground size-3.5" data-icon />
            </div>
          </>
        ) : (
          children
  ...
  return (
    <TooltipPrimitive.Portal>
      <TooltipPrimitive.Content
        className={cn(
          "bg-primary text-primary-foreground z-50 w-fit origin-(--radix-tooltip-content-transform-origin) rounded-none px-3 py-1.5 text-xs text-balance",
          className,
        )}
