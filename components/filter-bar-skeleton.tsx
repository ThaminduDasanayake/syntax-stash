    ...
    <div className="filter-bar">
      <div className="filter-bar-inner">
        <div className="filter-search-wrap">
          <MagnifyingGlassIcon weight="bold" className="filter-search-icon text-muted-foreground/50" />
          <Input
        ...
        <div className="filter-pills">
          {PILL_WIDTHS.map((width, i) => (
            <div
              key={i}
              className="filter-pill border-border/60 flex items-center border bg-card/60 opacity-60"
            >
