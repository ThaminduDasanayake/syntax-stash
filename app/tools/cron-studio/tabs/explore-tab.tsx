    ...
    <div className="grid grid-cols-1 gap-8 lg:grid-cols-2">
          ...
          <div className="space-y-3 pt-2">
            ...
            <TooltipProvider>
              <div className="bg-muted border-accent relative h-12 overflow-hidden border">
                ...
                <span className="text-foreground text-mono-2xs pointer-events-none absolute bottom-1 left-2 z-10">
                  Now
                </span>
                <span className="text-foreground text-mono-2xs pointer-events-none absolute right-2 bottom-1 z-10">
      ...
      <div className="space-y-2">
        <div className="flex items-center justify-between">
          ...
          <span className="bg-muted text-mono-xs px-2 py-0.5">{timezone}</span>
        </div>
