...
import { Corners, Mode, PRESETS } from "@/app/tools/border-radius-previewer/data";
import {
  buildCssBorderRadius,
  buildTailwindClass,
} from "@/app/tools/border-radius-previewer/helpers";
...
export default function BorderRadiusPage() {
  ...
  const MAX = 200;
  const tool = internalTools.find((t) => t.url === "/tools/border-radius-previewer");
