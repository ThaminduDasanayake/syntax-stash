...
const CLASSIC_WORDS = [
  ...
  "beatae", "vitae", "dicta", "explicabo", "nemo", "ipsam", "aspernatur", "aut", "odit",
  "fugit", "consequuntur", "magni", "dolores", "eos", "ratione", "sequi", "nesciunt",
  "neque", "porro", "quisquam", "quia", "numquam", "eius", "modi", "tempora", "incidunt",
  "aliquam", "quaerat", "minima", "nostrum", "exercitationem", "ullam", "corporis",
  "suscipit", "laboriosam", "nisi", "aliquid", "commodi", "consequatur", "quis",
...
const HIPSTER_WORDS = [
  "artisan", "pour-over", "fixie", "vinyl", "gastropub", "synth", "aesthetic",
  "letterpress", "chicharrones", "selvage", "normcore", "typewriter", "vegan",
  "keffiyeh", "williamsburg", "brookly", "craft", "beer", "organic", "tofu",
  "locavore", "tumblr", "mustache", "seitan", "cardigan", "twee", "scenester",
  "pork", "belly", "tote", "bag", "irony", "raw", "denim", "trust", "fund",
  "mixtape", "ethical", "plaid", "messenger", "bicycle", "rights", "bushwick",
  "polaroid", "forage", "small", "batch", "authentic", "listicle", "occupy",
  "narwhal", "pinterest", "chia", "quinoa", "flannel", "pabst", "bitters",
  "pickled", "distillery", "readymade", "chambray", "dreamcatcher",
  "skateboard", "drinking", "vinegar", "butcher", "mlkshk", "humblebrag",
  "retro", "cred", "taxidermy", "hoodie", "thundercats", "shoreditch",
  "meditation", "salvia", "fanny", "pack", "deep", "tattooed", "slow",
  "cold-pressed", "activated", "charcoal", "adaptogen", "collagen",
];

const CORPORATE_WORDS = [
  "synergy", "leverage", "paradigm", "disruptive", "scalable", "agile",
  "bandwidth", "boil", "ocean", "circle", "back", "deep", "dive",
  "drill", "down", "ecosystem", "empower", "end-to-end", "evangelize",
  "future-proof", "game-changer", "granular", "holistic", "ideate",
  "impactful", "incentivize", "innovate", "iteration", "key", "takeaways",
  "learnings", "low-hanging", "fruit", "move", "needle", "next", "level",
  "on", "same", "page", "optics", "outside", "box", "pivot", "proactive",
  "robust", "ROI", "scalability", "seamless", "socialized", "stakeholder",
  "streamline", "strategic", "synergize", "takeaway", "thought", "leader",
  "traction", "value-add", "vertical", "visibility", "win-win", "alignment",
  "bandwidth", "benchmark", "best-in-class", "bespoke", "blue-sky",
  "cadence", "cross-functional", "customer-centric", "deliverable",
  "dynamic", "engagement", "execution", "framework", "growth", "hacking",
  "impact", "initiative", "launch", "mindshare", "mission-critical",
  "onboarding", "optimization", "outreach", "pipeline", "platform",
  "priority", "proactive", "roadmap", "solution", "sprint", "strategy",
  "touch-base", "transformation", "transparency", "velocity",
];
