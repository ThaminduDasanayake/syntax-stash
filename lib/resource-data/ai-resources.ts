...
export const aiLinks: Tool[] = [
  ...
  {
    title: "Dify: Leading Agentic Workflow Builder",
    url: "https://dify.ai/",
    description:
  ...
  {
    title: "Unstructured - Unstructured Data Platform for GenAI",
  ...
  {
    title: "Awesome Claude — Claude AI Tools, Cheatsheet, Skills & MCP Servers",
  ...
  {
    title: "cloudflare/agentic-inbox",
