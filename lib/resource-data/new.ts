...
export const newLinks: Tool[] = [
  ...
  },
  {
    ...
    category: CATEGORIES.dev,
    description:
      "Curated toplist of everything Otaku culture. Up-to-date reviews of the best Anime/Manga websites, Apps, Light Novels, Music, Games, Asian Drama, VTuber, etc",
...

  {
    ...
    subtitle: "Open source form builder, built for small business success",
  ...
  },
  {
    ...
    category: CATEGORIES.dev,
    description:
      "Turn your data into AI workflows and custom apps that 100% fit your business. Connect everything and build anything your business needs.",
