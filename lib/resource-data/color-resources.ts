...
export const colorLinks: Resource<typeof CATEGORIES.colors>[] = [
  ...
  },
  {
    ...
    favicon:
      'data:image/svg+xml,<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 16 16"><style>circle{r:2px}</style><circle cx="3" cy="3" fill="%23ffb0cc"/><circle cx="8" cy="3" fill="%23ffb4b3"/><circle cx="13" cy="3" fill="%23ffba80"/><circle cx="3" cy="8" fill="%23eace58"/><circle cx="8" cy="8" fill="%23ade27f"/><circle cx="13" cy="8" fill="%2356edc5"/><circle cx="3" cy="13" fill="%2334e7ff"/><circle cx="8" cy="13" fill="%23a7d2ff"/><circle cx="13" cy="13" fill="%23d5c1ff"/></svg>',
