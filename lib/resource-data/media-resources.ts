...
export const mediaLinks: Resource<typeof CATEGORIES.media>[] = [
  ...
  },
  {
    ...
    favicon: "https://avataaars.com/images/favicon.png",
    ogImage: "https://avataaars.com/images/social.jpg",
    subtitle: "Avatar Illustrations Sketch Library",
    tags: [TAGS.avatars],
  ...
  },
  {
    ...
    author: "Pablo Stanley",
    category: CATEGORIES.media,
    description: "Mix & match robot illustrations in Sketch App with this free library.",
    favicon: "https://bottts.com/images/favicon.png",
    ogImage: "https://bottts.com/images/social.png",
    subtitle: "Robot Illustrations Sketch Library",
    tags: [TAGS.avatars],
  ...
  {
    title: "Free Userpics Pack",
    author: "Craftwork",
    category: CATEGORIES.media,
    description:
      "Collection of a hundred free userpics especially for your design projects. Fully vector, compatible with Figma.",
    favicon: "https://userpics.craftwork.design/images/apple-icon-180x180.png",
    ogImage: "https://userpics.craftwork.design/images/Open-Graph-1.png",
    tags: [TAGS.avatars],
    url: "https://userpics.craftwork.design/",
  },
  {
    title: "Fresh Folk",
    author: "Leni Kauffman",
    category: CATEGORIES.media,
    description: "An illustration library of people and objects",
    ogImage: "https://fresh-folk.com/assets/images/card.jpg",
    tags: [TAGS.illustration],
